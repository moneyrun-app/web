...
import { useDetailedReport } from '@/hooks/useApi';
import {
...
export default function ReportDetailPage() {
  ...
  const { data: detailed, isLoading } = useDetailedReport(id);
  ...
  if (!detailed) {
    return (
      <div className="text-center py-20">
        <p className="text-sub mb-4">리포트를 불러오지 못했어요</p>
